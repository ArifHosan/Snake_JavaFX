...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        background = new Image(String.valueOf(new File("files/grasses68.png").toURI()));
        snakeDownRight = new Image(String.valueOf(new File("files/rgp.png").toURI()));
        snakeDownLeft = new Image(String.valueOf(new File("files/rgl.png").toURI()));
        snakeUpRight = new Image(String.valueOf(new File("files/rdp.png").toURI()));
        snakeUpLeft = new Image(String.valueOf(new File("files/rdl.png").toURI()));
        snakeTailRight = new Image(String.valueOf(new File("files/op.png").toURI()));
        snakeTailLeft = new Image(String.valueOf(new File("files/ol.png").toURI()));
        snakeTailDown = new Image(String.valueOf(new File("files/od.png").toURI()));
        snakeTailUp = new Image(String.valueOf(new File("files/og.png").toURI()));
        snakeHeadRight = new Image(String.valueOf(new File("files/gr.png").toURI()));
        snakeHeadLeft = new Image(String.valueOf(new File("files/gl.png").toURI()));
        snakeHeadDown = new Image(String.valueOf(new File("files/gd.png").toURI()));
        snakeHeadUp = new Image(String.valueOf(new File("files/gu.png").toURI()));
        snakeHor = new Image(String.valueOf(new File("files/sh.png").toURI()));
        snakeVert = new Image(String.valueOf(new File("files/sv.png").toURI()));
        snakeFood = new Image(String.valueOf(new File("files/appleg.png").toURI()));
    ...
    public void initGame() {
        ...
        //Snake.add(new game.Sprite(snakeVert,200,290));
        //Snake.add(new game.Sprite(snakeVert,200,320));
        //Snake.add(new game.Sprite(snakeVert,200,350));
    ...
    public boolean isOver(Sprite s) {
        if (s.posX <= 0 || s.posY <= 0 || s.posX >= gameScene.getWidth() - 20 || s.posY > gameScene.getHeight() - 20)
            return true;
        for (Sprite it : Snake) {
    ...
    public void boot(Stage stage) {
        ...
        Label begin = new Label("SNAKE RUN");
        ...
        for (int i = 0; i < 9; i++)
            startImage.add(new Image(String.valueOf(new File("files/start/boy/" + i + ".png").toURI())));
        cur = 0;
        counter = 0;
